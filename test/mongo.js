...
var testTable = "test_mongo_gyro";
var testTableSequence = "test_mongo_gyro_sequence";

describe("Mongo", function() {
  it("should be able to create a new instance", function() {
    expect(new Mongo("mongodb://localhost:27017/test")).to.be.ok;
  });

  it("that new instance should have a localhost url by default", function() {
    expect(new Mongo("mongodb://localhost:27017/test").url).to.equal("mongodb://localhost:27017/test");
  })

  it("should be able to emit and receive events", function() {
    var mongo = new Mongo("mongodb://localhost:27017/test");
  ...
  describe("finders", function () {
    ...
    it("should be able to find test data with a sort in options", function() {
      ...
      return mongo.insert(testTable, {"name": "4321", "cid": _.uniqueId() })
        .then(function() {
    ...
    it("should be able to find test data with a limit in options", function() {
      ...
      return mongo.insert(testTable, { "name": "54321", "cid": _.uniqueId() })
        .then(function() {
          return mongo.insert(testTable, { "name": "54320", "cid": _.uniqueId() });
        })
        .then(function() {
  ...
  describe("insert", function() {
    it("should be able to insert test data", function() {
      return mongo.insert(testTable, {"name": "1234", "cid": _.uniqueId()}, 
  ...
  describe("aggregate", function() {
    it("should be able to run an aggregate function", function() {
      return mongo.insert(testTable, {"name": "1234567890", "value": 5, "cid": _.uniqueId()})
        .then(function(obj) {
  ...
  describe("Sequence", function() {
    before(function(done) {
      return mongo.insert(testTableSequence, {"name": "1234", "cid": _.uniqueId()}, 
        function(err, obj) {  // callback
          expect(mongo.isValidObjectID(obj[0]._id)).to.be.ok;
          expect(obj[0].name).to.equal(testData.name);
        })
    ...
    it("should be able to increment", function() {
      return mongo.getNextSequence(testTableSequence, { "name": "1234"}, { upsert: true }, 
  ...
  describe("EnsureIndex", function() {
    ...
    it("should be able to create a unique index", function() {
      return mongo.ensureIndex(testTable, "cid", {"unique": 1})
        .then(function(obj) { //pr
          expect(obj).to.be.undefined;
          return mongo.insert(testTable, { "email": "blah@blah.com", "cid": _.uniqueId() });
        })
        .then(function() {
          return mongo.insert(testTable, {"email": "blah@blah.com", "cid": _.uniqueId()});
        })
